export default function About() {
  return (
    <section
      id="about"
      className="scroll-mt-32 w-full min-h-screen py-20 px-6 text-white font-grotesk bg-black/70 backdrop-blur-sm"
      data-aos="fade-up"
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-6 text-md md:text-lg text-white/70 italic">
